...
<meta name="viewport"
  ...
  <div class="container-fluid" style="margin-top:5%;">
	<div class="row">
        ...
        <h3 class="form-signin-heading">Admin Sistemine Giriş</h3>
        <label for="inputtcno" class="sr-only">Email address</label>
        <input type="text" name="tcno" class="form-control" placeholder="Tc No" required autofocus>
        <br>
